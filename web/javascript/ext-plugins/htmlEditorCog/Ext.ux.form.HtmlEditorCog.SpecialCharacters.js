 ...
 */
Ext.ux.form.HtmlEditorCog.SpecialCharacters = Ext.extend(Ext.util.Observable, {
    /**
        ...
        var btn = this.cmp.getToolbar().addButton({
            ...
            handler: function(){
                ...
                this.charWindow = new Ext.Window({
                    title: Application.i18n.getMsg( 'editorTex.plugins.sc.titulo' ),
                    width: 436,
                    autoHeight: true,
                    iconCls: 'iconeInserirCaractere',
                    modal: true,
                    layout: 'fit',
                    items: [{
                        xtype: 'dataview',
