...
/**
 * Testes do SimpleXML para o SCORM.
 *
 * @author David Buzatto
 */
public class TestesSimpleXMLSCORM {
    ...
    public static void main( String[] args ) {
        ...
        Item i = new Item();
        i.setIdentifier( "id" );
        i.setTitle( "titulo item" );
        i.setMetadata( metadata );
        items.add( i );

        List<Item> items2 = new ArrayList<Item>();
        Item i2 = new Item();
        i2.setIdentifier( "outro id" );
        i2.setTitle( "titulo item 2" );
        i2.setMetadata( metadata );
        items2.add( i2 );
        i.setItems( items2 );
        ...
        r1.setIdentifier( "meu id" );
        r1.setHref( "hrefff" );
        r1.setBase( "baseee" );
        r1.setScormType( Resource.ScormType.ASSET );
        r1.setMetadata( metadata );
