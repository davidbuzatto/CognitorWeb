...
/**
 * Tag InteractivityLevel de Educational.
 *
 * @author David Buzatto
 */
@Root( name = "interactivityLevel" )
@Entity
@Transactional
public class EducationalInteractivityLevel implements Serializable {
    ...
    @OneToOne( mappedBy = "interactivityLevel" )
