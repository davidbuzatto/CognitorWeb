...
/**
 * Tag InteractivityType de Educational.
 *
 * @author David Buzatto
 */
@Root( name = "interactivityType" )
@Entity
@Transactional
public class EducationalInteractivityType implements Serializable {
    ...
    @OneToOne( mappedBy = "interactivityType" )
