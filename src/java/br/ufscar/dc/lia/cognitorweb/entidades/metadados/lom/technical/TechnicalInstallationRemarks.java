...
/**
 * Tag InstallationRemarks de Technical.
 *
 * @author David Buzatto
 */
@Root( name = "nstallationRemarks" )
@Entity
@Transactional
public class TechnicalInstallationRemarks implements Serializable {

    @Id
    @GeneratedValue
    private long id;

    @OneToOne( mappedBy = "installationRemarks" )
