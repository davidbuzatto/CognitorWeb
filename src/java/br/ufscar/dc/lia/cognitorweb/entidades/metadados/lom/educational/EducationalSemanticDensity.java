...
/**
 * Tag SemanticDensity de Educational.
 *
 * @author David Buzatto
 */
@Root( name = "semanticDensity" )
@Entity
@Transactional
public class EducationalSemanticDensity implements Serializable {
    ...
    @OneToOne( mappedBy = "semanticDensity" )
